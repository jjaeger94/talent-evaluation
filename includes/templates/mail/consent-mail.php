...
<p>Schön das du dich auf die Stelle <?php echo $job->jobname; ?> beworben hast.</p>
...
<p><a href="<?php echo esc_url(add_query_arg(array('id' => $application->application_id, 'key' => $review->filepath), home_url('/consent'))); ?>">Einverständniserklärung ausfüllen</a></p>
